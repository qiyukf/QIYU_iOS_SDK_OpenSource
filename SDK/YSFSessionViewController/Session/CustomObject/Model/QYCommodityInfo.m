...
- (BOOL)isEqual:(id)object {
    if ([object isMemberOfClass:[QYCommodityInfo class]]) {
        ...
        if (!_sendByUser) {
            ...
            if ((!_pictureUrlString && !newCommodityInfo.pictureUrlString)
                || [_pictureUrlString isEqualToString:newCommodityInfo.pictureUrlString]) {
                return YES;
            }
        }
    }
...
- (YSFCommodityInfoContentConfig *)contentConfig {
    return [[YSFCommodityInfoContentConfig alloc] init];
}
