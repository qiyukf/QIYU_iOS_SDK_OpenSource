 ...
 *  群类型
 */
typedef NS_ENUM(NSInteger, YSF_NIMTeamType){
    /**
     *  普通群
     */
    YSF_NIMTeamTypeNormal       = 0,
    /**
     *  高级群
     */
    YSF_NIMTeamTypeAdvanced     = 1,
};

/**
 *  群验证方式
 */
typedef NS_ENUM(NSInteger, YSF_NIMTeamJoinMode) {
    /**
     *  允许所有人加入
     */
    YSF_NIMTeamJoinModeNoAuth    = 0,
    /**
     *  需要验证
     */
    YSF_NIMTeamJoinModeNeedAuth  = 1,
    /**
     *  不允许任何人加入
     */
    YSF_NIMTeamJoinModeRejectAll = 2,
};
 ...
 *  申请入群状态
 */
typedef NS_ENUM(NSInteger, YSF_NIMTeamApplyStatus) {
    /**
     *  无效状态
     */
    YSF_NIMTeamApplyStatusInvalid,
    /**
     *  已经在群里
     */
    YSF_NIMTeamApplyStatusAlreadyInTeam,
    /**
     *  申请等待通过
     */
    YSF_NIMTeamApplyStatusWaitForPass,
 ...
 *  @discussion 默认为普通群
 */
@property (nonatomic,assign)    YSF_NIMTeamType     type;
 ...
 */
@property (nonatomic,assign)    YSF_NIMTeamJoinMode joinMode;
 ...
 *  群类型
 */
@property (nonatomic,assign,readonly)    YSF_NIMTeamType type;
