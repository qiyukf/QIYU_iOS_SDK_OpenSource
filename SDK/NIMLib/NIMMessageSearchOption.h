...
typedef enum : NSUInteger {
     ...
     * 从新消息往旧消息查询
     */
    YSF_NIMMessageSearchOrderDesc       =   0,
    /*
     * 从旧消息往新消息查询
     */
    YSF_NIMMessageSearchOrderAsc        =   1,
    
} YSF_NIMMessageSearchOrder;
 ...
 *  检索顺序
 */
@property (nonatomic,assign)    YSF_NIMMessageSearchOrder order;
 ...
 */
@property (nonatomic,strong)      YSF_NIMMessage      *currentMessage;
