...
typedef enum : NSUInteger
{
     ...
     *  Jpeg格式
     */
    YSF_NIMImageFormatJPEG,
    /**
     *  Png格式
     */
    YSF_NIMImageFormatPNG,
} YSF_NIMImageFormat;

/**
 *  图片选项
 */
@interface YSF_NIMImageOption : NSObject
/**
 ...
 *  图片压缩格式,默认为JPEG
 */
@property (nonatomic,assign)    YSF_NIMImageFormat format;
 ...
 *  图片实例对象
 */
@interface YSF_NIMImageObject : NSObject<YSF_NIMMessageObject>
 ...
 *  图片选项
 */
@property (nonatomic ,strong) YSF_NIMImageOption *option;
