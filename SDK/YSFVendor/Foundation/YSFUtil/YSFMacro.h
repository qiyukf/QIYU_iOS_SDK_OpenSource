...
#define YSFCodeInvalidData      (-1)

#define QYBundleName            @"QYResource.bundle"
#define QYResourceBundle        [NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"QYResource" ofType:@"bundle"]]
#define QYResourceFromBundle(x) [QYBundleName stringByAppendingPathComponent:@#x]
