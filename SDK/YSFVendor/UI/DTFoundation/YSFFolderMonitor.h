...
typedef void (^YSFFolderMonitorBlock) (void);
...
@interface YSFFolderMonitor : NSObject
...
/**
 Creates a new YSFFolderMonitor to watch the folder at the given URL. Whenever there is a change on this folder the block is executed.
 ...
 */
+ (YSFFolderMonitor * _Nonnull)folderMonitorForURL:(NSURL * _Nonnull)URL block: (YSFFolderMonitorBlock _Nullable)block;
