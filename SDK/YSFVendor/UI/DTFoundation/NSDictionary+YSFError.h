...
@interface NSDictionary (YSFError)
 ...
 */
+ (NSDictionary *)ysf_dictionaryWithContentsOfURL:(NSURL *)URL error:(NSError **)error;
...
/** 
 ...
 @return A new dictionary that contains the dictionary at path, or `nil` if there is a file error or if the contents of the file are an invalid representation of a dictionary.
 */
+ (NSDictionary *)ysf_dictionaryWithContentsOfFile:(NSString *)path error:(NSError **)error;
...
/** 
 ...
 @return A new dictionary that contains the dictionary at path, or `nil` if there is a file error or if the contents of the file are an invalid representation of a dictionary.
 */
+ (NSDictionary *)ysf_dictionaryWithContentsOfData:(NSData *)data error:(NSError **)error;
