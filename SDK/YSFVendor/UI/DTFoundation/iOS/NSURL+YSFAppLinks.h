 ...
 */
+ (NSURL *)ysf_appStoreURLforApplicationIdentifier:(NSString *)identifier;
...
/** Returns the URL to open the mobile app store on the app's review page.
 ...
 @return Returns the URL to the direct app store link
 */
+ (NSURL *)ysf_appStoreReviewURLForApplicationIdentifier:(NSString *)identifier;
