...
/** YSFFoundation enhancements for `UIView` */
 ...
 */
- (void)ysf_setRoundedCornersWithRadius:(CGFloat)radius width:(CGFloat)width color:(UIColor *)color;
 ...
 */
- (void)ysf_addShadowWithColor:(UIColor *)color alpha:(CGFloat)alpha radius:(CGFloat)radius offset:(CGSize)offset;
...
*/
- (void)ysf_updateShadowPathToBounds:(CGRect)bounds withDuration:(NSTimeInterval)duration;
