 ...
 */
- (YSFVersion *)initWithMajor:(NSUInteger)major minor:(NSUInteger)minor maintenance:(NSUInteger)maintenance;
...
/**
 ...
 @returns The initialized `DTVersion`
 */
- (YSFVersion *)initWithMajor:(NSUInteger)major minor:(NSUInteger)minor maintenance:(NSUInteger)maintenance build:(NSUInteger)build;

/**
 creates and returns a YSFVersion object initialized using the provided string
 @param versionString The `NSString` to create a `DTVersion` from
 @returns A YSFVersion object or <code>nil</code> if the string is not a valid version number 
 */
+ (YSFVersion *)versionWithString:(NSString *)versionString;

/**
 creates and retuns a YSFVersion object initialized with the version information of the current application
 @returns A YSFVersion object or <code>nil</code> if the string of the current application is not a valid version number 
 */
+ (YSFVersion *)appBundleVersion;

/**
 creates and retuns a YSFVersion object initialized with the version information of the operating system
 @returns A YSFVersion object or <code>nil</code> if the string of the current application is not a valid version number 
 */
+ (YSFVersion *)osVersion;
...
*/
- (BOOL)isLessThenVersion:(YSFVersion *)version;

/**
 @param version The `DTVersion` to compare the receiver to
 @returns <code>true</code> if the give version is greater then this version
*/
- (BOOL)isGreaterThenVersion:(YSFVersion *)version;
 ...
 */
- (BOOL)isEqualToVersion:(YSFVersion *)version;
 ...
 */
- (NSComparisonResult)compare:(YSFVersion *)version;
