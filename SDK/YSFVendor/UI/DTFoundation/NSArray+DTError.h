 ...
 */
+ (NSArray *)ysf_arrayWithContentsOfURL:(NSURL *)URL error:(NSError **)error;
 ...
 */
+ (NSArray *)ysf_arrayWithContentsOfFile:(NSString *)path error:(NSError **)error;
 ...
 */
+ (NSArray *)ysf_arrayWithContentsOfData:(NSData *)data error:(NSError **)error;
@end
