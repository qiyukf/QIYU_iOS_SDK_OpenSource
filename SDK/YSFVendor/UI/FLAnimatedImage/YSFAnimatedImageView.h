...
@class YSFAnimatedImage;
@protocol YSFAnimatedImageViewDebugDelegate;
...
//
@interface YSFAnimatedImageView : UIImageView
...
@property (nonatomic, strong) YSFAnimatedImage *animatedImage;
