 ...
 */
@interface YSFCoreTextFontDescriptor : NSObject <NSCopying, NSCoding>
 ...
 */
+ (YSFCoreTextFontDescriptor *)fontDescriptorWithFontAttributes:(NSDictionary *)attributes;
...
/**
 ...
 @returns An initialized font descriptor
 */
+ (YSFCoreTextFontDescriptor *)fontDescriptorForCTFont:(CTFontRef)ctFont;
