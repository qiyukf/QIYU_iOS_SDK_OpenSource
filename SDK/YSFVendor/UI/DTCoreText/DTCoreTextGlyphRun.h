...
@interface YSFCoreTextGlyphRun : NSObject 
{
...
/**
 ...
 @returns An initialized YSFCoreTextGlyphRun
 */
- (id)initWithRun:(CTRunRef)run layoutLine:(YSFCoreTextLayoutLine *)layoutLine offset:(CGFloat)offset;
 ...
 */
@property (nonatomic, readonly) YSFTextAttachment *attachment;
