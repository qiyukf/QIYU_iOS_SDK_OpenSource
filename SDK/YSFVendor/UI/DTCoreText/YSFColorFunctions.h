 ...
 */
YSFColor *YSFColorCreateWithHexString(NSString *hexString);
 ...
 */
YSFColor *YSFColorCreateWithHTMLName(NSString *name);
 ...
 */
NSString *YSFHexStringFromDTColor(YSFColor *color);
