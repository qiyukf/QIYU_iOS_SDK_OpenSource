 ...
 */
@interface YSFCoreTextLayoutLine : NSObject
{
	// IVAR required by YSFRichTextEditor, used in category
 ...
 */
@property (nonatomic, readonly) YSFCoreTextParagraphStyle *paragraphStyle;
...
/**
 ...
 Note: This is used to shortcut drawing of text lines and to allow a horizontal rule line have an "endlessly wide" width so that it gets picked up by [YSFCoreTextLayoutFrame linesVisibleInRect:].
 */
 ...
 */
- (YSFCoreTextLayoutLine *)justifiedLineWithFactor:(CGFloat)justificationFactor justificationWidth:(CGFloat)justificationWidth;
