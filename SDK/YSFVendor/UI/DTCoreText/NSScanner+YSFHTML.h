 ...
 */
- (BOOL)ysf_scanCSSAttribute:(NSString * __autoreleasing*)name value:(id __autoreleasing*)value;
...
/**
 ...
 @returns `YES` if an URL String could be scanned
 */
- (BOOL)ysf_scanCSSURL:(NSString * __autoreleasing*)urlString;
 ...
 */
- (BOOL)ysf_scanHTMLColor:(YSFColor * __autoreleasing*)color;
...
/**
 ...
 @returns `YES` if a color could be scanned
 */
- (BOOL)ysf_scanHTMLColor:(YSFColor * __autoreleasing*)color HTMLName:(NSString * __autoreleasing*)name;
