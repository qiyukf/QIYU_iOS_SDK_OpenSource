 ...
 */
@interface YSFCSSStylesheet : NSObject <NSCopying>
 ...
 */
+ (YSFCSSStylesheet *)defaultStyleSheet;
 ...
 */
- (void)mergeStylesheet:(YSFCSSStylesheet *)stylesheet;
 ...
 */
- (NSDictionary *)mergedStyleDictionaryForElement:(YSFHTMLElement *)element matchedSelectors:(NSSet * __autoreleasing*)matchedSelectors ignoreInlineStyle:(BOOL)ignoreInlineStyle;
