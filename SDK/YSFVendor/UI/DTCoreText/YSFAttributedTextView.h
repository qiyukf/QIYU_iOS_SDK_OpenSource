...
@class YSFAttributedTextView;

/**
 This view is designed to be a replacement for `UITextView`. It is a `UIScrollView` subclass and creates a <YSFAttributedTextContentView> as content view for displaying the text.
 
 The content view of type <YSFAttributedTextContentView> is created lazily. You should not set values on it directly if you use it in conjunction with this class for scrolling.
 */

@interface YSFAttributedTextView : UIScrollView
{
	// ivars needed by subclasses
	YSFAttributedTextContentView *_attributedTextContentView;
}
...
/**
 A delegate implementing YSFAttributedTextContentViewDelegate to provide custom subviews for images and links.
 */
@property (nonatomic, YSF_WEAK_PROPERTY) IBOutlet id <YSFAttributedTextContentViewDelegate> textDelegate;
...
/**
 References to the YSFAttributedTextContentView that display the text. This is not named contentView because this class inherits from `UIScrollView` which has an internal property of this name
 */
@property (nonatomic, strong, readonly) YSFAttributedTextContentView *attributedTextContentView;
...
/**
 ...
 Defaults to `YES` if you supply your own link drawing  then set this property to NO and supply your custom view (e.g. <YSFLinkButton>) via the <textDelegate>.
 */
...
/**
 ...
 Defaults to `YES` if you supply your own image drawing then set this property to NO and supply your custom image view (e.g. <YSFLazyImageView>) via the <textDelegate>.
 */
...
/**
 You can override this method to provide a different class to use for the content view. If you replace the content view class then it should inherit from <YSFAttributedTextContentView> which is also the default.
