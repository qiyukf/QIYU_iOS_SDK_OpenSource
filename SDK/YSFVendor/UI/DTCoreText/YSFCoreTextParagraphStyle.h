 ...
 */
@interface YSFCoreTextParagraphStyle : NSObject <NSCopying>

/**
 @name Creating a YSFCoreTextParagraphStyle
 */

/**
 Returns the default paragraph style.
 */
+ (YSFCoreTextParagraphStyle *)defaultParagraphStyle;
 ...
 */
+ (YSFCoreTextParagraphStyle *)paragraphStyleWithCTParagraphStyle:(CTParagraphStyleRef)ctParagraphStyle;
 ...
 */
+ (YSFCoreTextParagraphStyle *)paragraphStyleWithNSParagraphStyle:(NSParagraphStyle *)paragraphStyle;
...
/** 
 Text lists containing the paragraph, nested from outermost to innermost. Each text list is a YSFCSSListStyle object.
*/
...
/** 
 Text blocks containing the paragraph, nested from outermost to innermost, to array. Each text block is a YSFTextBlock object.
 */
