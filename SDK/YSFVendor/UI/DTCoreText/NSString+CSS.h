 ...
 */
- (NSDictionary *)ysf_dictionaryOfCSSStyles;
 ...
 */
- (BOOL)ysf_isCSSLengthValue;

/**
 Calculates a pixel-based length from the receiver based on the current text size in pixels. Used in YSFHTMLElement.
 ...
 */
- (CGFloat)ysf_pixelSizeOfCSSMeasureRelativeToCurrentTextSize:(CGFloat)textSize textScale:(CGFloat)textScale;
 ...
 */
- (NSArray *)ysf_arrayOfCSSShadowsWithCurrentTextSize:(CGFloat)textSize currentColor:(YSFColor *)color;

/**
 Decodes a content attribute which might contained unicode sequences.
 */
- (NSString *)ysf_stringByDecodingCSSContentAttribute;
