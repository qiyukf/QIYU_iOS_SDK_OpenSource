...
/**
 ...
 For a list of available options to pass to any of these methods please refer to [YSFHTMLAttributedStringBuilder initWithHTML:options:documentAttributes:].
 */
...
/**
 ...
 @see [YSFHTMLAttributedStringBuilder initWithHTML:options:documentAttributes:] for a list of available options
 */
- (id)ysf_initWithHTMLData:(NSData *)data documentAttributes:(NSDictionary * __autoreleasing*)docAttributes;
...
/**
 ...
 @see [YSFHTMLAttributedStringBuilder initWithHTML:options:documentAttributes:] for a list of available options
 */
- (id)ysf_initWithHTMLData:(NSData *)data baseURL:(NSURL *)baseURL documentAttributes:(NSDictionary * __autoreleasing*)docAttributes;
...
/**
 ...
 @returns Returns an initialized object, or `nil` if the data can’t be decoded.
  @see [YSFHTMLAttributedStringBuilder initWithHTML:options:documentAttributes:] for a list of available options
 */
- (id)ysf_initWithHTMLData:(NSData *)data options:(NSDictionary *)options documentAttributes:(NSDictionary * __autoreleasing*)docAttributes;
