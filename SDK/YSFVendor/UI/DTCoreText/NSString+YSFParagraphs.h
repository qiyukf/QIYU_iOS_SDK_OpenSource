 ...
 */
- (NSRange)ysf_rangeOfParagraphsContainingRange:(NSRange)range parBegIndex:(NSUInteger *)parBegIndex parEndIndex:(NSUInteger *)parEndIndex;
 ...
 */
- (BOOL)ysf_indexIsAtBeginningOfParagraph:(NSUInteger)index;
 ...
 */
- (NSRange)ysf_rangeOfParagraphAtIndex:(NSUInteger)index;
 ...
 */
- (NSUInteger)ysf_numberOfParagraphs;
