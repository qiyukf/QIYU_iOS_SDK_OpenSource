 ...
 */
@interface YSFCoreTextLayouter : NSObject 
...
/**
 Creates a layout frame with a given rectangle and string range. The layouter fills the layout frame with as many lines as fit. You can query [YSFCoreTextLayoutFrame visibleStringRange] for the range the fits and create another layout frame that continues the text from there to create multiple pages, for example for an e-book.
 ...
 */
- (YSFCoreTextLayoutFrame *)layoutFrameWithRect:(CGRect)frame range:(NSRange)range;
