...
@interface YSFCoreTextFontCollection : NSObject 
 ...
 */
+ (YSFCoreTextFontCollection *)availableFontsCollection;
 ...
 */
- (YSFCoreTextFontDescriptor *)matchingFontDescriptorForFontDescriptor:(YSFCoreTextFontDescriptor *)descriptor;
