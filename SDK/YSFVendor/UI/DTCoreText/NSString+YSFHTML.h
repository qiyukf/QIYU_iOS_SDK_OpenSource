 ...
 */
- (NSUInteger)ysf_integerValueFromHex;
 ...
 */
- (BOOL)ysf_isIgnorableWhitespace;
 ...
 */
- (NSString *)ysf_stringByNormalizingWhitespace;
 ...
 */
- (BOOL)ysf_hasPrefixCharacterFromSet:(NSCharacterSet *)characterSet;
 ...
 */
- (BOOL)ysf_hasSuffixCharacterFromSet:(NSCharacterSet *)characterSet;
 ...
 */
- (NSString *)ysf_stringByAddingHTMLEntities;
 ...
 */
- (NSString *)ysf_stringByReplacingHTMLEntities;
 ...
 */
- (NSString *)ysf_stringByAddingAppleConvertedSpace;
