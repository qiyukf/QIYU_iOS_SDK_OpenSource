 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const YSFWebImageCoderScaleDownLargeImagesKey;
 ...
 */
CG_EXTERN CGColorSpaceRef _Nonnull YSFCGColorSpaceGetDeviceRGB(void);
 ...
 */
CG_EXTERN BOOL YSFCGImageRefContainsAlpha(_Nullable CGImageRef imageRef);
 ...
 */
@protocol YSFWebImageCoder <NSObject>
...
/**
 ...
 @param optionsDict A dictionary containing any decompressing options. Pass {YSFWebImageCoderScaleDownLargeImagesKey: @(YES)} to scale down large images
 ...
 */
- (BOOL)canEncodeToFormat:(YSFImageFormat)format;

/**
 Encode the image to image data.

 @param image The image to be encoded
 @param format The image format to encode, you should note `YSFImageFormatUndefined` format is also  possible
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image format:(YSFImageFormat)format;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol YSFWebImageProgressiveCoder <YSFWebImageCoder>
