...
/**
 ...
 For a full GIF support, we recommend `FLAnimatedImage` or our less performant `YSFWebImageGIFCoder`
 ...
 */
@interface YSFWebImageImageIOCoder : NSObject <YSFWebImageProgressiveCoder>
