...
#import "YSFWebImageFrame.h"

@interface YSFWebImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<YSFWebImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<YSFWebImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage;

#if YSF_UIKIT || YSF_WATCH
/**
