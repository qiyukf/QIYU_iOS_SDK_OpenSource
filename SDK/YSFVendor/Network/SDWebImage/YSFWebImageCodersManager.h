...
/**
 ...
 Coders
 ------
 A coder must conform to the `YSFWebImageCoder` protocol or even to `YSFWebImageProgressiveCoder` if it supports progressive decoding
 ...
 */
@property (nonatomic, strong, readwrite, nullable) NSArray<YSFWebImageCoder>* coders;
...
/**
 ...
 @param coder coder
 */
- (void)addCoder:(nonnull id<YSFWebImageCoder>)coder;
...
/**
 ...
 @param coder coder
 */
- (void)removeCoder:(nonnull id<YSFWebImageCoder>)coder;
