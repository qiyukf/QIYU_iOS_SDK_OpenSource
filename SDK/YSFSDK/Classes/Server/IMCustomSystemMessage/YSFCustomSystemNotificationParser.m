        ...
        if (dict) {
            ...
            switch (cmd) {
                ...
                case YSFCommandRevokeMessageResult:
                    ...
                    break;
                case YSFCommandReadSessionRequest:
                    result = [YSFStaffReadStatus dataByJson:dict];
                    break;
                case YSFCommandEvaluationConfig:
                    result = [YSFEvaluationConfig dataByJson:dict];
                    break;
                case YSFCommandMessageFormResult:
                    result = [YSFMessageFormResponse dataByJson:dict];
                    break;
                case YSFCommandInputtingReceive:
                    result = [YSFInputtingStatus dataByJson:dict];
                    break;
